...
A sample msgpack-JSON `xl.meta`, you can debug the content inside `xl.meta` using [xl-meta.go](https://github.com/foens/minio/tree/master/docs/debugging#decoding-metadata) program.
