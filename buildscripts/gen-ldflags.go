...
func genLDFlags(version string) string {
	ldflagsStr := "-s -w"
	ldflagsStr += " -X github.com/foens/minio/cmd.Version=" + version
	ldflagsStr += " -X github.com/foens/minio/cmd.ReleaseTag=" + releaseTag(version)
	ldflagsStr += " -X github.com/foens/minio/cmd.CommitID=" + commitID()
	ldflagsStr += " -X github.com/foens/minio/cmd.ShortCommitID=" + commitID()[:12]
	ldflagsStr += " -X github.com/foens/minio/cmd.GOPATH=" + os.Getenv("GOPATH")
	ldflagsStr += " -X github.com/foens/minio/cmd.GOROOT=" + os.Getenv("GOROOT")
	return ldflagsStr
}
